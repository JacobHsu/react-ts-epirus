...
import { EContractsMultiFilterType } from './models-table-contracts';
import { ETokensMultiFilterType } from './models-table-tokens';
import { ETransactionsMultiFilterType } from './models-table-transactions';
...
export type TMultiFilterType =
  | EContractsMultiFilterType
  | ETokensMultiFilterType
  | ETransactionsMultiFilterType;
