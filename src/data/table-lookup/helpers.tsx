...
import { ITransactionsData } from 'models/models-table-transactions';
...
export const renderEventsData = (data: IEventsData) => {
  if (isHash(data.eventName)) {
    return (
      <ToolTipCellCopy textStyle={{ color: '#434343' }} contentToCopy={data.transactionHash}>
...
export const renderFunctionCell = (data: ITransactionsData) => {
...
export const renderFunctionInline = (data: ITransactionsData) => {
  if (defined(data.functionMeta)) {
